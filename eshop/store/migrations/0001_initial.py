# Generated by Django 2.1.8 on 2019-08-29 20:50
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('up', models.IntegerField(default=0, verbose_name='是否上架')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', ckeditor_uploader.fields.RichTextUploadingField(verbose_name='描述')),
        ...
        migrations.AddField(
            model_name='goods',
            name='goodstype',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='store.GoodsType', verbose_name='所属类型'),
        ),
        migrations.AddField(
            model_name='goods',
            name='store',
